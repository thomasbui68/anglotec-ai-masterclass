...
const DEFAULT_META: MetaTags = {
  title: "Anglotec AI Masterclass | 3,000 AI Prompts — Learn Prompt Engineering",
  description: "Master 3,000 AI prompting phrases across 12 expert categories. The complete AI prompt engineering course for beginners to power users. 14-day free trial.",
...
const ROUTE_META: Record<string, MetaTags> = {
  "/": {
    title: "Anglotec AI Masterclass | 3,000 AI Prompts — Learn Prompt Engineering",
    description: "Master 3,000 AI prompting phrases across 12 expert categories. From beginner to AI power-user. Start free.",
  ...
  "/login": {
    ...
    description: "Sign in to your AI Masterclass account. Access 3,000 AI prompts, track your progress, and continue your AI learning journey.",
    keywords: "AI masterclass login, AI prompts login, prompt engineering sign in",
  },
  "/register": {
    title: "Get Started Free — Anglotec AI Masterclass",
    description: "Create your free account and start mastering 3,000 AI prompting phrases. No credit card required. Beginner-friendly.",
  ...
  "/flashcards": {
    ...
    description: "Practice 3,000 AI prompting phrases with interactive flashcards. Voice pronunciation, progress tracking, and gamified learning.",
  ...
  "/pricing": {
    ...
    description: "Start free with 20 prompts/day. Upgrade to Pro for £19.99/mo — unlimited 3,000+ prompts, all 12 categories, AI voice. 14-day free trial.",
